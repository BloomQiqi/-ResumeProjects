...
cc.Class({
    ...
    RunForward:function(){
        ...
        var car_action = cc.speed(
            cc.spawn(
                cc.moveTo(0.1, -594.549, car_y.y),
                cc.fadeOut(1)
            ), 0.05);
        this.button.runAction(car_action);
        //cc.log("car");
        ...
        this.schedule(function(){
            var garbage2_action = cc.speed(
                cc.spawn(
                    cc.show(),
                    cc.fadeIn(0.01),
                    // cc.moveTo(0.07,61.88, car_y.y),
                ),0.01);
        ...
        this.schedule(function(){
            var garbage4_action = cc.speed(
                cc.spawn(
                    cc.show(),
                    cc.fadeIn(0.01),
                    // cc.moveTo(0.1,243.18, car_y.y),
                ),0.01);
            this.garbage4.runAction(garbage4_action);
        },0.5,0,0)
        
        //this.schedule(this.garbage4.runAction(garbage4_action),this.garbage4,1.0,0);
        ...
        this.schedule(function(){
            var garbage3_action = cc.speed(
                cc.spawn(
                    cc.show(),
                    cc.fadeIn(0.01),
                    // cc.moveTo(0.05,106.825, car_y.y),
                ),0.01);
        ...
        this.schedule(function(){
            var garbage1_action = cc.speed(
                cc.spawn(
                    cc.show(),
                    cc.fadeIn(0.01),
                    // cc.moveTo(0.03,-256.426, car_y.y),
                ),0.01);
